...
from DenseNet.encoder import Encoder
from DenseNet.decoder import Decoder
from DenseNet.dense_block import DenseBlk

FCDenseNetVariants = {
    56: {'layers_in_dense_blocks': [4, 4, 4, 4], 'layers_in_bottleneck': 4, 'layers_in_TU_blocks': [4, 4, 4, 4],
         'growth_rate': 12, 'name': 'FCDenseNet56'},
    67: {'layers_in_dense_blocks': [5, 5, 5, 5], 'layers_in_bottleneck': 5, 'layers_in_TU_blocks': [5, 5, 5, 5],
...
class FCDenseNet(tf.keras.Model):
    def __init__(self,
                 ...
                 mode: str) -> None:
        """
        Whole model of different variants of FCDenseNet (including 3x3 conv - encoder - bottleneck - decoder - 1x1 conv)
