...
NUM_CLASS = 2
IMAGE_SIZE = 224
model = FCDenseNet(NUM_CLASS, 56, "Test")
model.load_weights(
    "/home/hossein/ImageSegmentation/DenseNet/weights/NaiveLoss1/")
...
img = tf.io.read_file("/DenseNet/testImages/second_overhead_cam.jpg")
